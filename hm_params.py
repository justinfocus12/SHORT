...
def get_algo_params():
    ...
    lag_time_current_display = lag_time_seq[20] # For displaying current vector fields
    lag_halftime_current_display = lag_time_seq[10] # For computing  the up and down components of current
    ...
    algo_params = dict({
        ...
        'lag_halftime_current_display': lag_halftime_current_display,
