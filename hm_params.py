...
def get_algo_params():
    ...
    lag_time_current_display = lag_time_seq[2] # For displaying current vector fields
    lag_halftime_current_display = lag_time_seq[1] # For computing  the up and down components of current
